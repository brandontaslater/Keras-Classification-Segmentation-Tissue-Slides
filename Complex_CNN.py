...
# File paths
TRAINING_LOGS_FILE = "Complex_Final_224_224.csv"
MODEL_SUMMARY_FILE = "Complex_Final_224_224.txt"
...
def train():
    # name = "SGD3Class_32-32-64-64-0.001-{}".format(int(time.time()))
    ...
    model.save_weights('models/Complex_Final_224_224.h5')
...
#loading singular
load_trained_model_single_image("models/Complex_Final_224_224.h5")